<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:42:"./application/admin/template/table/add.htm";i:1577698462;s:72:"/www/wwwroot/crms.cdqifa.cn/application/admin/template/public/layout.htm";i:1571728726;s:72:"/www/wwwroot/crms.cdqifa.cn/application/admin/template/public/footer.htm";i:1571728726;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <form class="form-horizontal" id="post_form" action="<?php echo url('Table/add'); ?>" method="post">
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" name="name" value="" id="" class="input-txt">
                    <span class="err"></span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" name="num_seats" value="" id="" class="input-txt">
                    <span class="err"></span>
