<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:44:"./application/admin/template/shops\index.htm";i:1578479255;s:59:"D:\WWW\diancan\application\admin\template\public\layout.htm";i:1571728726;s:56:"D:\WWW\diancan\application\admin\template\member\bar.htm";i:1578555694;s:60:"D:\WWW\diancan\application\admin\template\shops\shop_bar.htm";i:1573115084;s:59:"D:\WWW\diancan\application\admin\template\public\footer.htm";i:1571728726;}*/ ?>
<!doctype html>
<html>
<head>
...
<!--         <div class="fixed-bar">
    ...
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <form class="navbar-form form-inline" id="postForm" action="<?php echo url('Shops/index'); ?>" method="get" onsubmit="layer_loading('正在处理');">
    ...
    <?php endif; ?> -->
                        ...
                        <tr>
                            ...
                            <td class="" style="width: 100%;">
                                <div class="tl" style="padding-left: 10px;">
                                    <a href="<?php echo url('Shops/order_details',array('order_id'=>$vo['order_id'])); ?>"><?php echo $vo['order_code']; ?></a>
                                </div>
                            </td>
                            <td class="">
                                <div class="w100 tc">
                            ...
                            <td>
                                <div class="w280 tc">
                                    <a href="<?php echo url('Shops/order_details',array('order_id'=>$vo['order_id'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>详情</a>
                                    ...
                                    <?php endif; if($vo['order_status'] == '1'): ?>
                                        <!-- 订单待发货时出现 -->
                                     <!--    <a href="JavaScript:void(0);" data-url="<?php echo url('Shops/order_send', ['order_id'=>$vo['order_id']]); ?>" onclick="OrderSend(this);" class="btn blue"> -->
                                 
                                            <i class="fa fa-pencil-square-o"></i>已付款
                                   ...
                                   <!--      <a href="JavaScript:void(0);" onclick="OrderMark('gbdd','<?php echo $vo['order_id']; ?>','<?php echo $vo['users_id']; ?>');" class="btn blue">
                                    ...
                                    <?php endif; if(-1 == $vo['order_status'] or 4 == $vo['order_status']): ?>
                                        ...
                                        <a href="JavaScript:void(0);" onclick="OrderMark('ddbz','<?php echo $vo['order_id']; ?>','<?php echo $vo['users_id']; ?>','<?php echo $vo['admin_note']; ?>');" class="btn blue">
                                            ...
                                            <input type="hidden" id="beizhu-url" value="<?php echo url('Shops/update_note'); ?>">
                                        </a>
                                    ...
                                    <?php endif; if($vo['order_status'] == 1): ?>
                                     <a href="JavaScript:void(0);" url="<?php echo url('Shops/print_order',array('order_id'=>$vo['order_id'])); ?>" class="print_order btn blue">
        ...
        <div class="tDiv">
            <div class="tDiv2">
                ...
                <div class="fbutton">
                    <a onclick="batch_del(this, 'ids');" data-url="<?php echo url('Shops/order_del'); ?>">
...
<script>
    $(document).ready(function(){
        ...
        function syn_theme_shop()
        {
            ...
            $.ajax({
                type : 'get',
                url : "<?php echo url('Shops/ajax_syn_theme_shop'); ?>",
                data : {_ajax:1},
                dataType : 'json',
    ...
    function OrderMark(status_name,order_id,users_id,admin_note){
        ...
        layer.confirm(msg, {
            ...
            $.ajax({
                url: "<?php echo url('Shops/order_mark_status'); ?>",
    ...
    function UpNote(order_id,admin_note){
        $.ajax({
            url: "<?php echo url('Shops/update_note'); ?>",
