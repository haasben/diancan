<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:47:"./application/admin/template/member/pay_set.htm";i:1578274672;s:72:"/www/wwwroot/crms.cdqifa.cn/application/admin/template/public/layout.htm";i:1571728726;s:69:"/www/wwwroot/crms.cdqifa.cn/application/admin/template/member/bar.htm";i:1578555694;s:72:"/www/wwwroot/crms.cdqifa.cn/application/admin/template/public/footer.htm";i:1571728726;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <div class="mDiv">
            ...
            <div class="sDiv">
                <div class="sDiv2 addartbtn fl" style="margin-right: 6px;">
                    <input type="button" class="btn selected" value="接口配置" onclick="window.location.href='<?php echo url("Member/pay_set"); ?>';">
                </div>
                <div class="sDiv2 addartbtn fl" style="margin-right: 6px;">
            ...
            <div class="ncap-form-default">
                ...
                <dl class="row">
                    ...
                    <dd class="opt">
                        ...
                        <p class="notic">请输入您的微信小程序中的微信AppId，用于微信支付。</p>
                    </dd>
                </dl>
                <dl class="row">
                    <dt class="tit">
                ...
                <dl class="row">
                    ...
                    <dd class="opt">
                        ...
                        <p class="notic">请输入您的微信小程序中的微信AppSecret，用于手机端微信支付。</p>
                    </dd>
                </dl>
                <dl class="row">
