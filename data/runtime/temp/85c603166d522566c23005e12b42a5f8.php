<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:53:"./application/admin/template/public\dispatch_jump.htm";i:1577762884;}*/ ?>
...
<?php switch($code): case "1": 
        ...
        <div class="system-message">
            <div class="tit">
                <i class="glyphicon glyphicon-ok-circle"></i><span><b>成功<?php echo $msg; ?>菜品</b>请选择你的后续操作：</span>
            </div>
            <ul>
                <li><span><?php echo $msg1; ?>菜品</span><a href="<?php echo $addurl; ?>" style="display: none;"><?php echo $msg1; ?>菜品</a></li>
    <!--             <li><span>查看菜品</span><a href="<?php echo $arcurl; ?>" target="_blank" style="display: none;">查看菜品</a></li> -->
                <li><span>更改菜品</span><a href="<?php echo \think\Request::instance()->baseFile(); ?>?m=admin&c=Archives&a=edit&id=<?php echo $data['aid']; ?>&typeid=<?php echo $data['tid']; ?>&lang=<?php echo (\think\Request::instance()->param('lang') ?: 'cn'); ?>" style="display: none;">更改菜品</a></li>
                <li><span>已发布菜品管理</span><a href="<?php echo $listurl; ?>" style="display: none;">已发布菜品管理</a></li>
            ...
            <div class="buttom" id="tips">正在生成当前菜品……请勿刷新！</div>
