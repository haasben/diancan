<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:51:"./application/admin/template/member\money_index.htm";i:1577764178;s:59:"D:\WWW\diancan\application\admin\template\public\layout.htm";i:1571728724;s:56:"D:\WWW\diancan\application\admin\template\member\bar.htm";i:1578276579;s:59:"D:\WWW\diancan\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
...
<!--                     <div class="sDiv2 addartbtn fl" style="margin-right: 6px;">
                        <input type="button" class="btn selected" value="账户充值记录" onclick="window.location.href='<?php echo url("Member/money_index"); ?>';">
                    </div> -->
                </div>
            </form>
        </div>
