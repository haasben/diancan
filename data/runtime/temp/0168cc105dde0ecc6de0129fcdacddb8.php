<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:49:"./application/admin/template/channeltype\edit.htm";i:1573115083;s:59:"D:\WWW\diancan\application\admin\template\public\layout.htm";i:1571728724;s:59:"D:\WWW\diancan\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <form class="form-horizontal" id="post_form" action="<?php echo url('Channeltype/edit'); ?>" method="post">
        <div class="ncap-form-default">
            ...
            <?php endif; if($field['nid'] == 'article'): if($IsOpenRelease == '1'): ?>
                    <dl class="row">
                        <dt class="tit">
                            <label>开启会员投稿</label>
                        </dt>
