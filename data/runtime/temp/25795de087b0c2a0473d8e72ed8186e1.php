<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:43:"./application/admin/template/table\edit.htm";i:1577758948;s:59:"D:\WWW\diancan\application\admin\template\public\layout.htm";i:1571728726;s:59:"D:\WWW\diancan\application\admin\template\public\footer.htm";i:1571728726;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <form class="form-horizontal" id="post_form" action="<?php echo url('Table/edit'); ?>" method="post">
        <input type="hidden" name="id" value="<?php echo $table_data['id']; ?>">
        <div class="ncap-form-default">
            <dl class="row">
                <dt class="tit">
                    <label for="title"><em>*</em>桌号名称</label>
                </dt>
                <dd class="opt">
                    <input type="text" name="name" value="<?php echo $table_data['name']; ?>" id="" class="input-txt">
                    <span class="err"></span>
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="title"><em></em>座位数</label>
                </dt>
                <dd class="opt">
                    <input type="text" name="num_seats" value="<?php echo $table_data['num_seats']; ?>" id="" class="input-txt">
                    <span class="err"></span>
                    <p class="notic">不填默认4人</p>
                </dd>
            </dl>
