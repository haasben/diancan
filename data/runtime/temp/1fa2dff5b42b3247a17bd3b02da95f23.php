<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:47:"./application/admin/template/auth_role\edit.htm";i:1578291045;s:59:"D:\WWW\diancan\application\admin\template\public\layout.htm";i:1571728724;s:61:"D:\WWW\diancan\application\admin\template\admin\admin_bar.htm";i:1573115082;s:59:"D:\WWW\diancan\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
                ...
                <dd class="opt">
                    ...
                    <div class="admin_poplistdiv">
                        ...
                        <ul>
                            ...
                            <li>
                                <label><input type="checkbox" name="permission[plugins][<?php echo $plugin['code']; ?>][code]" value="<?php echo $plugin['code']; ?>" <?php if(! empty($info['permission']['plugins'][$plugin['code']]) && ! empty($info['permission']['plugins'][$plugin['code']]['child'])): ?> checked="checked"<?php endif; ?> /><?php echo $plugin['name']; ?></label>
