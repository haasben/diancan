<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:43:"./application/admin/template/system/web.htm";i:1578623735;s:72:"/www/wwwroot/crms.cdqifa.cn/application/admin/template/public/layout.htm";i:1571728726;s:69:"/www/wwwroot/crms.cdqifa.cn/application/admin/template/system/bar.htm";i:1578538496;s:72:"/www/wwwroot/crms.cdqifa.cn/application/admin/template/public/footer.htm";i:1571728726;}*/ ?>
<!doctype html>
<html>
<head>
...
<?php endif; ?>
    <form method="post" id="handlepost" action="<?php echo url('System/web'); ?>" enctype="multipart/form-data" name="form1">
        <div class="ncap-form-default">
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="web_logo">店铺LOGO</label>
                </dt>
                <dd class="opt">
                    ...
                    <span class="err"></span>
                    <p class="notic">默认店铺LOGO，通用头部显示，显示尺寸以模板设计为主</p>
                </dd>
                <?php if($web_cmsmode == '2'): ?>
                <dd class="variable">
...
<!--             <dl class="row"><dt class="tit"><label><b>店铺第三方代码</b></label></dt></dl>
            <dl class="row">
                <dt class="tit">
