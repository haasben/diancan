<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"./application/admin/template/system\web2.htm";i:1578538534;s:59:"D:\WWW\diancan\application\admin\template\public\layout.htm";i:1571728726;s:56:"D:\WWW\diancan\application\admin\template\system\bar.htm";i:1578538496;s:59:"D:\WWW\diancan\application\admin\template\public\footer.htm";i:1571728726;}*/ ?>
<!doctype html>
<html>
<head>
...
<!--             <dl class="row">
  ...
  <!--           <dl class="row">
            ...
            <dl class="row" style="display: none">
                ...
                <dd class="opt">
                    http://order.io:8084/<input type="hidden" name="adminbasefile_old" value="<?php echo (isset($adminbasefile) && ($adminbasefile !== '')?$adminbasefile:'login'); ?>"><input id="adminbasefile" name="adminbasefile" value="<?php echo (isset($adminbasefile) && ($adminbasefile !== '')?$adminbasefile:'login'); ?>" type="text" data-site_url="http://order.io:8084" onKeyUp="this.value=this.value.replace(/[^0-9a-zA-Z_-]/g,'');" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^0-9a-zA-Z_-]/g,''));" style="width: 80px;" />.php
