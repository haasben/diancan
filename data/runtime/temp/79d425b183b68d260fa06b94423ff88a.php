<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:45:"./application/admin/template/product/edit.htm";i:1578621888;s:72:"/www/wwwroot/crms.cdqifa.cn/application/admin/template/public/layout.htm";i:1571728726;s:77:"/www/wwwroot/crms.cdqifa.cn/application/admin/template/field/addonextitem.htm";i:1573695226;s:85:"/www/wwwroot/crms.cdqifa.cn/application/admin/template/diy_extend/archives_extend.htm";i:1571728726;s:72:"/www/wwwroot/crms.cdqifa.cn/application/admin/template/public/footer.htm";i:1571728726;}*/ ?>
<!doctype html>
<html>
<head>
...
<script type="text/javascript" src="/public/plugins/Ueditor/ueditor.config.js?v=v1.4.2"></script>
<script type="text/javascript" src="/public/plugins/Ueditor/ueditor.all.min.js?v=v1.4.2"></script>
<script type="text/javascript" src="/public/plugins/Ueditor/lang/zh-cn/zh-cn.js?v=v1.4.2"></script>
    ...
    <form class="form-horizontal" id="post_form" action="<?php echo url('Product/edit'); ?>" method="post">
        ...
        <?php endif; if(1 == $shopConfig['shop_open'] && !empty($ifcontrolRow['users_price'])): if(empty($shopConfig['shop_open_spec'])): ?>
            ...
            <?php else: ?>
                ...
                <script type="text/javascript">
                    // 规格列表管理
                    var TemplateUrl = "<?php echo url('Shops/spec_template'); ?>";
                    // 规格选择
                    var SelectUrl = "<?php echo url('Shops/spec_select'); ?>";
                    // 获取规格名称规格值框架URL
                    var GetHtmlUrl = "<?php echo url('Shops/assemble_spec_data'); ?>";
                    // 当规格库更新后，调用此方式及时更新选择规格名称的下拉框信息
                    var GetPresetSpecUrl = "<?php echo url('Shops/update_spec_info'); ?>";
                    // 同步更新规格库数据到产品规格中，单条操作
                    var RefreshSpecUrl = "<?php echo url('Shops/refresh_spec_value'); ?>";
                </script>
                <script type="text/javascript">
                    $(function () {
                        var stock_count = 0;
